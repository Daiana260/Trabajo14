            ...
            <div class="row">
                    <div class="row table-responsive" style="width:80%;margin-left:10%;margin-top:5%;">
                        ...
                        <div class="shadow-lg p-3 mb-5 bg-white rounded" style="width:40%; float:left; margin-left:5%;">
                            <div class="card-body">
                                <h2 class="card-title"><?php echo $row['nomCompleto']; ?></h2>
                                <p>Email: <?php echo $row['email']; ?></p>
                                <p>Telefono: <?php echo $row['telefono']; ?></p>
                                <p>Sexo: <?php echo $row['sexo']; ?></p>
                                <a href="modificar.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-success">Modificar</a>
                                <a href="eliminar_perfil.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-danger">Eliminar</a>
                            </div>
                        </div>
                        <?php } ?>
                </div>
