    ...
    <div class="box" style="padding: 20px; width: 500px; margin: auto; margin-top: 20px; background-color: rgb(207, 207, 209);">
        ...
        <form method="POST" action="savePerfil.php">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nomCompleto" value="<?php echo $row['nomCompleto'];?>">
            </div>
            <div class="form-group">
                <label>Email</label>
            ...
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="sexo" value="Femenino" value="<?php echo $row['sexo'];?>">
                    <label class="form-check-label" for="inlineRadio1">Femenino</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="sexo" value="Masculino" value="<?php echo $row['sexo'];?>">
                    <label class="form-check-label" for="inlineRadio2">Masculino</label>
                </div>
            </div>
            <input type="submit" class="btn btn-success" value="modificarPerfil.php">
